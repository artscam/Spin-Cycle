...
public class RayTracingMaster : MonoBehaviour
{
    ...
    public float SpherePlacementRadius = 75f;
    ...
    private void RebuildMeshObjectBuffers()
    {
        ...
        //loop over all objets and gather their data
        foreach (RayTracingObject obj in _rayTracingObjects)
        {
            ...
            //add index data - if the buffer wasn't empty before, the indices need to be offset
